<template>
  <!-- SideBar Template from Carol Skelly for Codeply -->
  <div class="container-fluid">
    ...
    <div class="row flex-nowrap">
        ...
        <template #cardBody>
         <span><input type="text" id="task-input" placeholder="Enter a task"></span> 
         <div class="d-flex justify-content-center gap-2">
  <button @click="sortTasksAlphabetically()" class="btn">Sort</button>
  <button @click="addTask()" class="btn">Add Task</button>
   ...
   <br>
    ...
    <ul v-if="sales && sales.length" ref="content">
       ...
       <CardComp>
   <template #cardHeader> 
      <svg version="1.1" viewBox="0 0 2048 2048" width="30" height="30" xmlns="http://www.w3.org/2000/svg"  class="pop-icon">
